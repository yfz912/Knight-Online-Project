class com.mgame.webMall.page.commonStorePage.StorePageAtype
{
    var _parent, index;
    function StorePageAtype()
    {
    } // End of the function
    ...
    function removeList()
    {
        ...
        {
            thisPageData.__get__main()["listTable" + _loc2].removeMovieClip();
        } // end of for
    ...
    function stageCheck()
    {
        if (thisPageData.__get__main().listTable1 != undefined)
        {
            for (var _loc2 = 1; _loc2 <= 30; ++_loc2)
            {
                thisPageData.__get__main()["listTable" + _loc2].removeMovieClip();
    ...
    function makeListTable()
    {
        ...
        for (var _loc2 = 1; _loc2 <= listCount; ++_loc2)
        {
            ...
            {
                _loc4 = thisPageData.__get__main()["listTable" + (_loc2 - 1)]._y + thisPageData.__get__main()["listTable" + (_loc2 - 1)]._height + 1;
            } // end else if
            _loc3 = thisPageData.__get__main().attachMovie("listTable", "listTable" + _loc2, thisPageData.__get__main().getNextHighestDepth(), {_x: _loc5, _y: _loc4});
            _loc3.index = _loc2;
    ...
    function buttonEvent()
    {
        ...
        for (var _loc2 = 1; _loc2 <= listCount; ++_loc2)
        {
            thisPageData.__get__main()["listTable" + _loc2].buyButton.onRelease = function ()
            {
                var _loc2 = _parent.index;
                com.mgame.webMall.util.CommonPopup.popupStart("buy_normal", _this.returnXmlData.setArrayData(_this.thisPageData.itemArr, _loc2 - 1, "normalShop"));
            };
            thisPageData.__get__main()["listTable" + _loc2].cartButton.onRelease = function ()
            {
                var _loc2 = _parent.index;
                com.mgame.webMall.util.CommonPopup.popupStart("basket", _this.returnXmlData.setArrayData(_this.thisPageData.itemArr, _loc2 - 1, "normalShop"));
            };
        } // end of for
    } // End of the function
    function setTextInfoData(target, index)
    {
        ...
        target.content_txt.html = true;
        target.content_txt.multiline = true;
        target.content_txt.wordWrap = true;
        ...
        {
            target.money_txt.text = com.mgame.webMall.text.PagePackageTextDefine.commonStorePage_StorePageAtype_189;
        }
        else if (returnXmlData.setArrayData(thisPageData.__get__itemArr(), index - 1, "normalShop").limit_type != "0")
        {
            target.money_txt.html = true;
            target.money_txt.htmlText = com.mgame.webMall.text.PagePackageTextDefine.commonStorePage_StorePageAtype_195;
        }
        else
        {
        ...
        target.content_txt.htmlText = textLengthCheck.trim(returnXmlData.setArrayData(thisPageData.__get__itemArr(), index - 1, "normalShop").explain1, 70);
        var _loc8 = 32;
        var _loc10 = 32;
    ...
    function makePageListNumber(blockSize)
    {
        ...
        var _loc4 = _loc3 + 9;
        var _loc7 = thisPageData.__get__main()["listTable" + listCount]._y + thisPageData.__get__main()["listTable" + listCount]._height + 2;
    ...
    function jsCall_multi_viewItem()
    {
        ...
        for (var _loc2 = 1; _loc2 <= listCount; ++_loc2)
        {
            if (thisPageData.__get__main()["listTable" + _loc2].checkBox.checkBox.selected)
            {
    ...
    function checkCancel()
    {
        for (var _loc2 = 1; _loc2 <= listCount; ++_loc2)
        {
            thisPageData.__get__main()["listTable" + _loc2].checkBox.checkBox.selected = false;
        } // end of for
    } // End of the function
