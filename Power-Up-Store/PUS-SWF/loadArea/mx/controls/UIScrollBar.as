class mx.controls.UIScrollBar extends mx.controls.scrollClasses.ScrollBar
{
    ...
    function onTextChanged(Void)
    {
        ...
        if (this.__get__horizontal())
        {
            var _loc3 = textField.hscroll;
            this.setScrollProperties(textField._width, 0, textField.maxhscroll);
            this.__set__scrollPosition(Math.min(_loc3, textField.maxhscroll));
        }
        else
        {
            _loc3 = textField.scroll;
            var _loc2 = textField.bottomScroll - textField.scroll;
            this.setScrollProperties(_loc2, 1, textField.maxscroll);
            this.__set__scrollPosition(Math.min(_loc3, textField.maxscroll));
        } // end else if
    } // End of the function
