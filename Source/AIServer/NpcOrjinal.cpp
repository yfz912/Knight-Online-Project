...
bool CNpc::RandomMove()
{
	...
	if (m_byMoveType == 2 && (GetProtoID() == 19070 || GetProtoID() == 19071 || GetProtoID() ==19072))
	{
	...
	else if (m_byMoveType == 1 || m_byMoveType == 2)	
	{
		random_x = 4;
		random_z = 4;
...
void CNpc::RecvAttackReq(int nDamage, uint16 sAttackerID, AttributeType attributeType /*= AttributeNone*/)
{
	...
	if (GetType() != NPC_CHAOS_STONE && m_NpcState != NPC_FAINTING)
	{
