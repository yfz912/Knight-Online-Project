...
void CServerDlg::color_c(char* buff, WORD color)
{
...
void CServerDlg::SendConsoleFAIL()
{
...
void CServerDlg::Yaz(char* yazi, WORD color)
{
	char data[105];
...
{
	CIni ini("./Settings/AIServer.ini");
