...
public:
	...
	INLINE bool isNonAttackingObject() { return isGate() || GetType() == NPC_GATE_LEVER || isArtifact() || GetType() == NPC_SCARECROW || GetType() == NPC_TREE || GetType() == NPC_BYGROUP3; }
	INLINE bool isNonAttackableObject() { return isGate() || GetType() == NPC_GATE_LEVER || GetType() == NPC_BYGROUP3; }
...
public:
	...
	bool RegisterRegion(float x, float z , int id);
