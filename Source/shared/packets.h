...
#define WIZ_NATION_CHAT			0x19	// ChatRoom
...
#define WIZ_ALREADY_LOG			0x65 // login
...
#define WIZ_ITEM_MONTH			0x74 //s�reli item
...
#define WIZ_BOARDING_FAILED		0x84
