...
const uint8 VIP_HAVE_MAX		= 48; // 48 Vip inventory slots
const uint8 COSP_MAX			= 6; // 5 cospre slots
...
//2039 = 443||2083+ = 455 21xx+ 560// 0 not count        ----- Archieve Fix NxWiLe
#define ACHIEVE_TOTAL		560

// Prmeium Slots in Account
#define PREMIUM_TOTAL		6

// Quest Counts TEST
#define QUEST_TOTAL	 5	
...
struct	_ITEM_DATA
{
	...
	INLINE bool isSpecial() { return SealSerial > 0; }
...
#define ACHIEVE_QUEST_ARRAY_SIZE	1500 // That's a limit of 500 quests (3 bytes per quest)
