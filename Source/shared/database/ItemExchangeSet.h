...
public:
	...
	virtual tstring GetColumns() 
	{
		return _T("nIndex, bRandomFlag, "
			...
			"nOriginItemNum5, nOriginItemCount5, nExchangeItemNum1, nExchangeItemCount1,  "
			"nExchangeItemNum2, nExchangeItemCount2, nExchangeItemNum3, nExchangeItemCount3, "
			"nExchangeItemNum4, nExchangeItemCount4, nExchangeItemNum5, nExchangeItemCount5, "
			"nUnk2, nUnk3, nUnk4, nUnk5");
	}
