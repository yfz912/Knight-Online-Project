...
public:
	...
	virtual tstring GetColumns() { return _T("Num, strName, Kind, Slot, Race, Class, Damage, Delay, Range, Weight, Duration, BuyPrice, SellPrice, Ac, Countable, Effect1, Effect2, ReqLevel, ReqLevelMax, ReqRank, ReqTitle, ReqStr, ReqSta, ReqDex, ReqIntel, ReqCha, SellingGroup, ItemType, Hitrate, Evasionrate, DaggerAc, JamadarAC, SwordAc, MaceAc, AxeAc, SpearAc, BowAc, FireDamage, IceDamage, LightningDamage, PoisonDamage, HPDrain, MPDamage, MPDrain, MirrorDamage, StrB, StaB, DexB, IntelB, ChaB, MaxHpB, MaxMpB, FireR, ColdR, LightningR, MagicR, PoisonR, CurseR,ItemClass,ItemExt,UpgradeNotice,NPbuyPrice,Bound"); }
	...
	virtual bool Fetch()
	{
		...
		_dbCommand->FetchUInt16(i++, pData->m_sJamadarAc);
		...
		_dbCommand->FetchByte(i++, pData->UpgradeNotice);
		_dbCommand->FetchUInt32(i++, pData->m_iNPBuyPrice);
		_dbCommand->FetchByte(i++, pData->m_Bound);
