...
DEFINE_LUA_CLASS
	...
	MAKE_LUA_METHOD(GetRebLevel)
	MAKE_LUA_METHOD(GetMaxExp)
	...
	MAKE_LUA_METHOD(isBeginnerKurPor)
	...
	MAKE_LUA_METHOD(isNoviceKurPor)
	...
	MAKE_LUA_METHOD(isMasteredKurPor)
	...
	MAKE_LUA_METHOD(TempleEventJoin)
	MAKE_LUA_METHOD(TempleEventLeave)
	...
	MAKE_LUA_METHOD(GetCountEmptySlot)
	...
	MAKE_LUA_METHOD(GetEventZoneTime)
	MAKE_LUA_METHOD(GetEventZoneUserCount)
...
LUA_WRAPPER_USER_FUNCTION(GetMaxExp);
...
LUA_WRAPPER_USER_FUNCTION(isKurPor);
...
_LUA_WRAPPER_USER_FUNCTION(ShowBulletinBoard, ShowBulletinBoard);
//_LUA_WRAPPER_USER_FUNCTION(RecvOpenDeletedItems, RecvDeletedItems);
