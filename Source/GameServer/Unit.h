...
public:
	...
	INLINE bool haveSkill() { return m_bSkillActive; }
	INLINE bool haveSkill2() { return m_bSkillActive2; }
	INLINE bool isPassiveRush() { return m_PassiveRush; }
	...
	uint8	CastleMilitary;
	uint8	EslantMilitary;
	uint8	MoradonMilitary;
