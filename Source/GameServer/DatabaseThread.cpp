...
void CUser::ReqUserLogOut()
{
	...
	UserInOut(INOUT_OUT);
	g_DBAgent.UpdateUserAchieve(GetName(), UPDATE_LOGOUT, this);
	g_DBAgent.UpdateUser(GetName(), UPDATE_LOGOUT, this);
	g_DBAgent.UpdateWarehouseData(GetAccountName(), UPDATE_LOGOUT, this);
	g_DBAgent.UpdateWarehouseDataVip(GetAccountName(), UPDATE_LOGOUT, this);
...
{
	g_DBAgent.UpdateUserAchieve(GetName(), UPDATE_PACKET_SAVE, this); //Achieve Save Infos
	g_DBAgent.UpdateUser(GetName(), UPDATE_PACKET_SAVE, this);
	g_DBAgent.UpdateWarehouseData(GetAccountName(), UPDATE_PACKET_SAVE, this);
	g_DBAgent.UpdateWarehouseDataVip(GetAccountName(), UPDATE_PACKET_SAVE, this);
	g_DBAgent.UpdateSavedMagic(this);
}
...
void CKnightsManager::ReqKnightsAlliancePunish(CUser *pUser, Packet & pkt) {
	...
	if (pTargetClan != nullptr && !pTargetClan->m_strChief.empty()) {
