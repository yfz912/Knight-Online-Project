...
public:
	...
	bool GetClanUserData(uint16 sClanID, _KNIGHTS_USER* p);
	...
	bool LoadUserAchieve(CUser *pUser);
	...
	bool LoadWarehouseDataVip(std::string & strAccountID, CUser *pUser);
	...
	//void SaveSkillShortcut(short sCount, char *buff, CUser *pUser); CanEklentisi
	...
	bool UpdateUserAchieve(std::string & strCharID, UserUpdateType type, CUser *pUser);
	...
	bool UpdateWarehouseDataVip(std::string & strAccountID, UserUpdateType type, CUser *pUser);
	...
	int8 UpdateItemFromLetter(std::string & strCharID, uint32 nLetterID, uint32 & nItemID, uint16 & sCount, uint16 & sDurability, uint32 & nCoins, uint64 & nSerialNum);
	...
	int8 NationTransferValidate(std::string strCharID);
	int8 NationTransferSave(std::string strAccountID, std::string kCharID, uint8 kNewRace, uint8 kNation, uint16 kClass, CUser * pUser);
	int8 NationTransfer(std::string strAccountID, std::string strCharID);
