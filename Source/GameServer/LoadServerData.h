...
typedef CSTLMap <_ACHIEVE_MON>				AchieveMonArray;
...
typedef std::vector<_MINE_LIST>						MineList;
typedef CSTLMap <MineList>							MineListArray;
...
typedef CSTLMap <_SPECIAL_ITEM>						SpecialItemArray;