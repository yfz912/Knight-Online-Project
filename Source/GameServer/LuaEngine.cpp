...
DEFINE_LUA_FUNCTION_TABLE(g_globalFunctions,
						  ...
						  MAKE_LUA_FUNCTION(CheckRebLevel)
						  ...
						  //MAKE_LUA_FUNCTION(RecvDeletedItems)
...
bool CLuaEngine::Initialise()
{
	...
	printf("Game quest is succesfully loaded. - [%s]\n", LUA_RELEASE);
...
void CLuaEngine::color_c(char* buff, WORD color)
{
...
void CLuaEngine::SendConsoleFAIL()
{
...
void CLuaEngine::Yaz(char* yazi, WORD color)
{
	char data[105];
