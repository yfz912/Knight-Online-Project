...
if (EVENT == 533) then
	UpdateEvent(UID, 4088);
end

if (EVENT == 534) then
	UpdateEvent(UID, 4091); 
end

if (EVENT == 535) then
	UpdateEvent(UID, 4090);
...
if (EVENT == 225) then
	UpdateEvent(UID, 3143);
end

if (EVENT == 226) then
	UpdateEvent(UID, 3145);
...
if (EVENT == 305) then
	UpdateEvent(UID, 3163);
end

if (EVENT == 306) then
	UpdateEvent(UID, 3165);
...
if (EVENT == 405) then
	UpdateEvent(UID, 3183);
end

if (EVENT == 406) then
	UpdateEvent(UID, 3185);
	SelectMsg(UID, 2, 312, 3086, NPC, 21, 193);
end

if (EVENT == 407) then
	UpdateEvent(UID, 3186);
end
