...
if (EVENT == 705) then
	UpdateEvent(UID, 3283);
end

if (EVENT == 706) then
	UpdateEvent(UID, 3285);
...
if (EVENT == 533) then
	UpdateEvent(UID, 4100);
end

if (EVENT == 534) then
	UpdateEvent(UID, 4103);
end

if (EVENT == 535) then
	UpdateEvent(UID, 4102);
...
if (EVENT == 225) then
	UpdateEvent(UID, 3203);
end

if (EVENT == 226) then
	UpdateEvent(UID, 3205);
...
if (EVENT == 305) then
	UpdateEvent(UID, 3223);
end

if (EVENT == 306) then
	UpdateEvent(UID, 3225);
...
if (EVENT == 405) then
	UpdateEvent(UID, 3243);
end

if (EVENT == 406) then
	UpdateEvent(UID, 3245);
