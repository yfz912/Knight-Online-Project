...
if (EVENT == 533) then
	UpdateEvent(UID, 4307);
end

if (EVENT == 534) then
	UpdateEvent(UID, 4310);
end

if (EVENT == 180) then
	UpdateEvent(UID, 4309);
...
if (EVENT == 9364) then
	UpdateEvent(UID, 9388);
end

if (EVENT == 9368) then
	UpdateEvent(UID, 9391);
end

if (EVENT == 9365) then
	UpdateEvent(UID, 9390);
