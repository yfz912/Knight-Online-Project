...
if (EVENT == 410) then -- 28 Level War -> Boss
	UpdateEvent(UID, 820);
end
...
if (EVENT == 403) then
	UpdateEvent(UID, 9945);
end

if (EVENT == 404) then
	UpdateEvent(UID, 9948);
end

if (EVENT == 405) then
	SelectMsg(UID, 2, savenum, 1232, NPC, 10, 193);
	UpdateEvent(UID, 9947);
end
