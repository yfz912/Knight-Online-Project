...
if (EVENT == 8600) then -- 44 Level Ape
	...
	if (Class == 1 or Class == 5 or Class == 6) then
		UpdateEvent(UID, 8910);
	elseif (Class == 2 or Class == 7 or Class == 8) then
		UpdateEvent(UID, 8915);
	elseif (Class == 3 or Class == 9 or Class == 10) then
		UpdateEvent(UID, 8920);
	elseif (Class == 4 or Class == 11 or Class == 12) then
		UpdateEvent(UID, 8925);
	end
end
...
if (EVENT == 8612) then
	Class = CheckClass(UID);
	if (Class == 1 or Class == 5 or Class == 6) then
		UpdateEvent(UID, 8911);
	elseif (Class == 2 or Class == 7 or Class == 8) then
		UpdateEvent(UID, 8916);
	elseif (Class == 3 or Class == 9 or Class == 10) then
		UpdateEvent(UID, 8921);
	elseif (Class == 4 or Class == 11 or Class == 12) then
		UpdateEvent(UID, 8926);
	end
end
...
if (EVENT == 8619) then
	Class = CheckClass(UID);
	if (Class == 1 or Class == 5 or Class == 6) then
		UpdateEvent(UID, 8914);
	elseif (Class == 2 or Class == 7 or Class == 8) then
		UpdateEvent(UID, 8919);
	elseif (Class == 3 or Class == 9 or Class == 10) then
		UpdateEvent(UID, 8924);
	elseif (Class == 4 or Class == 11 or Class == 12) then
		UpdateEvent(UID, 8929);
	end
end
...
if (EVENT == 8613) then
	Class = CheckClass(UID);
	if (Class == 1 or Class == 5 or Class == 6) then
		UpdateEvent(UID, 8913);
		EVENT = 8614
	elseif (Class == 2 or Class == 7 or Class == 8) then
		UpdateEvent(UID, 8918);
		EVENT = 8614
	elseif (Class == 3 or Class == 9 or Class == 10) then
		UpdateEvent(UID, 8923);
		EVENT = 8614
	elseif (Class == 4 or Class == 11 or Class == 12) then
		UpdateEvent(UID, 8928);
		EVENT = 8614
	end
end
...
if (EVENT == 8618) then
	...
	elseif (Class == 2 or Class == 7 or Class == 8) then
		...
		UpdateEvent(UID, 8917);
	elseif (Class == 3 or Class == 9 or Class == 10) then
		ExpChange(UID, 1000000)
		GoldGain(UID, 100000)
		GiveItem(UID, 265003005, 1)
		UpdateEvent(UID, 8922);
	elseif (Class == 4 or Class == 11 or Class == 12) then
		ExpChange(UID, 1000000)
		GoldGain(UID, 100000)
		GiveItem(UID, 285003005, 1)
		UpdateEvent(UID, 8927);
	end	 
end
...
if (EVENT == 8270) then -- 45 Level Kongau
	Class = CheckClass(UID);
	if (Class == 1 or Class == 5 or Class == 6) then
		UpdateEvent(UID, 8868);
	elseif (Class == 2 or Class == 7 or Class == 8) then
		UpdateEvent(UID, 8873);
	elseif (Class == 3 or Class == 9 or Class == 10) then
		UpdateEvent(UID, 8878);
	elseif (Class == 4 or Class == 11 or Class == 12) then
		UpdateEvent(UID, 8883);
	end
end
...
if (EVENT == 8273) then
	Class = CheckClass(UID);
	if (Class == 1 or Class == 5 or Class == 6) then
		UpdateEvent(UID, 8869);
	elseif (Class == 2 or Class == 7 or Class == 8) then
		UpdateEvent(UID, 8874);
	elseif (Class == 3 or Class == 9 or Class == 10) then
		UpdateEvent(UID, 8879);
	elseif (Class == 4 or Class == 11 or Class == 12) then
		UpdateEvent(UID, 8884);
	end
end
...
if (EVENT == 8274) then
	Class = CheckClass(UID);
	if (Class == 1 or Class == 5 or Class == 6) then
		UpdateEvent(UID, 8872);
	elseif (Class == 2 or Class == 7 or Class == 8) then
		UpdateEvent(UID, 8877);
	elseif (Class == 3 or Class == 9 or Class == 10) then
		UpdateEvent(UID, 8882);
	elseif (Class == 4 or Class == 11 or Class == 12) then
		UpdateEvent(UID, 8887);
	end
end
...
if (EVENT == 8280) then
	Class = CheckClass(UID);
	if (Class == 1 or Class == 5 or Class == 6) then
		UpdateEvent(UID, 8871);
		EVENT = 8281
	elseif (Class == 2 or Class == 7 or Class == 8) then
		UpdateEvent(UID, 8876);
		EVENT = 8281
	elseif (Class == 3 or Class == 9 or Class == 10) then
		UpdateEvent(UID, 8881);
		EVENT = 8281
	elseif (Class == 4 or Class == 11 or Class == 12) then
		UpdateEvent(UID, 8886);
		EVENT = 8281
	end
end
...
if (EVENT == 8278) then
	...
	elseif (Class == 2 or Class == 7 or Class == 8) then
		...
		UpdateEvent(UID, 8875);
	elseif (Class == 3 or Class == 9 or Class == 10) then
		ExpChange(UID, 1500000)
		GoldGain(UID, 100000)
		GiveItem(UID, 265002005, 1)
		UpdateEvent(UID, 8880);
	elseif (Class == 4 or Class == 11 or Class == 12) then
		ExpChange(UID, 1500000)
		GoldGain(UID, 100000)
		GiveItem(UID, 285002005, 1)
		UpdateEvent(UID, 8885);
	end
end
...
if (EVENT == 8500) then -- 46 Level Burning Skeleton
	Class = CheckClass(UID);
	if (Class == 1 or Class == 5 or Class == 6) then
		UpdateEvent(UID, 8952);
		EVENT = 8501
	elseif (Class == 2 or Class == 7 or Class == 8) then
		UpdateEvent(UID, 8957);
		EVENT = 8501
	elseif (Class == 3 or Class == 9 or Class == 10) then
		UpdateEvent(UID, 8962);
		EVENT = 8501
	elseif (Class == 4 or Class == 11 or Class == 12) then
		UpdateEvent(UID, 8967);
		EVENT = 8501
	end
end
...
if (EVENT == 8503) then
	Class = CheckClass(UID);
	if (Class == 1 or Class == 5 or Class == 6) then
		UpdateEvent(UID, 8953);
	elseif (Class == 2 or Class == 7 or Class == 8) then
		UpdateEvent(UID, 8958);
	elseif (Class == 3 or Class == 9 or Class == 10) then
		UpdateEvent(UID, 8963);
	elseif (Class == 4 or Class == 11 or Class == 12) then
		UpdateEvent(UID, 8968);
	end
end
...
if (EVENT == 8504) then
	Class = CheckClass(UID);
	if (Class == 1 or Class == 5 or Class == 6) then
		UpdateEvent(UID, 8956);
	elseif (Class == 2 or Class == 7 or Class == 8) then
		UpdateEvent(UID, 8961);
	elseif (Class == 3 or Class == 9 or Class == 10) then
		UpdateEvent(UID, 8966);
	elseif (Class == 4 or Class == 11 or Class == 12) then
		UpdateEvent(UID, 8971);
	end
end
...
if (EVENT == 8510) then
	Class = CheckClass(UID);
	if (Class == 1 or Class == 5 or Class == 6) then
		UpdateEvent(UID, 8955);
		EVENT = 8511
	elseif (Class == 2 or Class == 7 or Class == 8) then
		UpdateEvent(UID, 8960);
		EVENT = 8511
	elseif (Class == 3 or Class == 9 or Class == 10) then
		UpdateEvent(UID, 8965);
		EVENT = 8511
	elseif (Class == 4 or Class == 11 or Class == 12) then
		UpdateEvent(UID, 8970);
		EVENT = 8511
	end
end
...
if (EVENT == 8508) then
	...
	elseif (Class == 2 or Class == 7 or Class == 8) then
		ExpChange(UID, 1000000)
		GoldGain(UID, 100000)
		UpdateEvent(UID, 8959);
	elseif (Class == 3 or Class == 9 or Class == 10) then
		ExpChange(UID, 1000000)
		GoldGain(UID, 100000)
		UpdateEvent(UID, 8964);
	elseif (Class == 4 or Class == 11 or Class == 12) then
		ExpChange(UID, 1000000)
		GoldGain(UID, 100000)
		UpdateEvent(UID, 8969);
	end
end
...
if (EVENT == 8073) then
	UpdateEvent(UID, 8992);
end

if (EVENT == 8074) then
	UpdateEvent(UID, 8995);
end

if (EVENT == 8075) then
	SelectMsg(UID, 2, 800, 8215, NPC, 3014, 153);
	UpdateEvent(UID, 8994);
end
...
if (EVENT == 8153) then
	UpdateEvent(UID, 9004);
end

if (EVENT == 8154) then
	UpdateEvent(UID, 9007);
end

if (EVENT == 8155) then
	SelectMsg(UID, 2, 841, 8215, NPC, 3014, 153);
	UpdateEvent(UID, 9006);
end
...
if (EVENT == 9470) then -- 50 Level Sheriff
	Class = CheckClass(UID);
	if (Class == 1 or Class == 5 or Class == 6) then
		UpdateEvent(UID, 9576);
	elseif (Class == 2 or Class == 7 or Class == 8) then
		UpdateEvent(UID, 9581);
	elseif (Class == 3 or Class == 9 or Class == 10) then
		UpdateEvent(UID, 9586);
	elseif (Class == 4 or Class == 11 or Class == 12) then
		UpdateEvent(UID, 9591);
	end
end
...
if (EVENT == 9473) then
	Class = CheckClass(UID);
	if (Class == 1 or Class == 5 or Class == 6) then
		UpdateEvent(UID, 9577);
	elseif (Class == 2 or Class == 7 or Class == 8) then
		UpdateEvent(UID, 9582);
	elseif (Class == 3 or Class == 9 or Class == 10) then
		UpdateEvent(UID, 9587);
	elseif (Class == 4 or Class == 11 or Class == 12) then
		UpdateEvent(UID, 9592);
	end
end
...
if (EVENT == 9474) then
	Class = CheckClass(UID);
	if (Class == 1 or Class == 5 or Class == 6) then
		UpdateEvent(UID, 9580);
	elseif (Class == 2 or Class == 7 or Class == 8) then
		UpdateEvent(UID, 9585);
	elseif (Class == 3 or Class == 9 or Class == 10) then
		UpdateEvent(UID, 9590);
	elseif (Class == 4 or Class == 11 or Class == 12) then
		UpdateEvent(UID, 9595);
	end
end
...
if (EVENT == 9480) then
	Class = CheckClass(UID);
	if (Class == 1 or Class == 5 or Class == 6) then
		UpdateEvent(UID, 9579);
	elseif (Class == 2 or Class == 7 or Class == 8) then
		UpdateEvent(UID, 9584);
	elseif (Class == 3 or Class == 9 or Class == 10) then
		UpdateEvent(UID, 9589);
	elseif (Class == 4 or Class == 11 or Class == 12) then
		UpdateEvent(UID, 9594);
	end
end
...
if (EVENT == 9478) then
	...
	if (Class == 1 or Class == 5 or Class == 6) then
		...
		UpdateEvent(UID, 9578);
	elseif (Class == 2 or Class == 7 or Class == 8) then
		ExpChange(UID, 4000000)
		GiveItem(UID, 910155113, 1)
		UpdateEvent(UID, 9583);
	elseif (Class == 3 or Class == 9 or Class == 10) then
		ExpChange(UID, 4000000)
		GiveItem(UID, 910153111, 1)
		UpdateEvent(UID, 9588);
	elseif (Class == 4 or Class == 11 or Class == 12) then
		ExpChange(UID, 4000000)
		GiveItem(UID, 910156114, 1)
		GiveItem(UID, 910154112, 1)
		UpdateEvent(UID, 9593);
	end
end
...
if (EVENT == 8553) then
	UpdateEvent(UID, 9052);
end

if (EVENT == 8554) then
	UpdateEvent(UID, 9055);
end

if (EVENT == 8555) then
	SelectMsg(UID, 2, 866, 8008, NPC, 3014, 153);
	UpdateEvent(UID, 9054);
end
...
if (EVENT == 9490) then -- 52 Level Garuna
	Class = CheckClass(UID);
	if (Class == 1 or Class == 5 or Class == 6) then
		UpdateEvent(UID, 9618);
	elseif (Class == 2 or Class == 7 or Class == 8) then
		UpdateEvent(UID, 9623);
	elseif (Class == 3 or Class == 9 or Class == 10) then
		UpdateEvent(UID, 9628);
	elseif (Class == 4 or Class == 11 or Class == 12) then
		UpdateEvent(UID, 9633);
	end
end
...
if (EVENT == 9493) then
	Class = CheckClass(UID);
	if (Class == 1 or Class == 5 or Class == 6) then
		UpdateEvent(UID, 9619);
	elseif (Class == 2 or Class == 7 or Class == 8) then
		UpdateEvent(UID, 9624);
	elseif (Class == 3 or Class == 9 or Class == 10) then
		UpdateEvent(UID, 9629);
	elseif (Class == 4 or Class == 11 or Class == 12) then
		UpdateEvent(UID, 9634);
	end
end
...
if (EVENT == 9494) then
	Class = CheckClass(UID);
	if (Class == 1 or Class == 5 or Class == 6) then
		UpdateEvent(UID, 9622);
	elseif (Class == 2 or Class == 7 or Class == 8) then
		UpdateEvent(UID, 9627);
	elseif (Class == 3 or Class == 9 or Class == 10) then
		UpdateEvent(UID, 9632);
	elseif (Class == 4 or Class == 11 or Class == 12) then
		UpdateEvent(UID, 9637);
	end
end
...
if (EVENT == 9500) then
	Class = CheckClass(UID);
	if (Class == 1 or Class == 5 or Class == 6) then
		UpdateEvent(UID, 9621);
	elseif (Class == 2 or Class == 7 or Class == 8) then
		UpdateEvent(UID, 9626);
	elseif (Class == 3 or Class == 9 or Class == 10) then
		UpdateEvent(UID, 9631);
	elseif (Class == 4 or Class == 11 or Class == 12) then
		UpdateEvent(UID, 9636);
	end
end
...
if (EVENT == 403) then
	UpdateEvent(UID, 2272);
end

if (EVENT == 404) then
	UpdateEvent(UID, 2275);
end

if (EVENT == 405) then
	UpdateEvent(UID, 2274);
end
...
if (EVENT == 9003) then
	UpdateEvent(UID, 9088);
end

if (EVENT == 9004) then
	UpdateEvent(UID, 9091);
end

if (EVENT == 9005) then
	SelectMsg(UID, 2, 869, 8008, NPC, 3014, 153);
	UpdateEvent(UID, 9090);
end
