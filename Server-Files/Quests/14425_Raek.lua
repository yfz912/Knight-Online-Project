...
if (EVENT == 533) then
	UpdateEvent(UID, 4314);
end

if (EVENT == 534) then
	UpdateEvent(UID, 4317);
end

if (EVENT == 180) then
	UpdateEvent(UID, 4316);
...
if (EVENT == 9364) then
	UpdateEvent(UID, 9394);
end

if (EVENT == 9368) then
	UpdateEvent(UID, 9397);
end

if (EVENT == 9365) then
	UpdateEvent(UID, 9396);
