...
if (EVENT == 8253) then
	UpdateEvent(UID, 9016);
end

if (EVENT == 8254) then
	UpdateEvent(UID, 9019);
end

if (EVENT == 8255) then
	SelectMsg(UID, 2, 843, 8266, NPC, 3007, 158);
	UpdateEvent(UID, 9018);
end
...
if (EVENT == 8353) then
	UpdateEvent(UID, 9028);
end

if (EVENT == 8354) then
	UpdateEvent(UID, 9031);
end

if (EVENT == 8355) then
	SelectMsg(UID, 2, 845, 8266, NPC, 3007, 158);
	UpdateEvent(UID, 9030);
end
...
if (EVENT == 8662) then
	UpdateEvent(UID, 9064);
end

if (EVENT == 8668) then
	UpdateEvent(UID, 9067);
end

if (EVENT == 8663) then
	SelectMsg(UID, 2, 850, 8300, NPC, 4080, 158);
	UpdateEvent(UID, 9066);
end
...
if (EVENT == 9183) then
	UpdateEvent(UID, 9076);
end

if (EVENT == 9184) then
	UpdateEvent(UID, 9079);
end

if (EVENT == 9185) then
	SelectMsg(UID, 2, 829, 8266, NPC, 3007, 158);
	UpdateEvent(UID, 9078);
end
...
if (EVENT == 9023) then
	UpdateEvent(UID, 9100);
end

if (EVENT == 9024) then
	UpdateEvent(UID, 9103);
end

if (EVENT == 9025) then
	SelectMsg(UID, 2, 871, 8266, NPC, 3007, 158);
	UpdateEvent(UID, 9102);
end
...
if (EVENT == 9043) then
	UpdateEvent(UID, 9112);
end

if (EVENT == 9044) then
	UpdateEvent(UID, 9115);
end

if (EVENT == 9045) then
	SelectMsg(UID, 2, 873, 8266, NPC, 3007, 158);
	UpdateEvent(UID, 9114);
end
...
if (EVENT == 9049) then
	ExpChange(UID, 10000000)
	UpdateEvent(UID, 9113);	 
end

if (EVENT == 9080) then -- 60 Level Deruvish
	Class = CheckClass(UID);
	if (Class == 1 or Class == 5 or Class == 6) then
		UpdateEvent(UID, 9150);
		EVENT = 9081
	elseif (Class == 2 or Class == 7 or Class == 8) then
		UpdateEvent(UID, 9155);
		EVENT = 9081
	elseif (Class == 3 or Class == 9 or Class == 10) then
		UpdateEvent(UID, 9160);
		EVENT = 9081
	elseif (Class == 4 or Class == 11 or Class == 12) then
		UpdateEvent(UID, 9165);
		EVENT = 9081
	end
end
...
if (EVENT == 9083) then
	Class = CheckClass(UID);
	if (Class == 1 or Class == 5 or Class == 6) then
		UpdateEvent(UID, 9151);
	elseif (Class == 2 or Class == 7 or Class == 8) then
		UpdateEvent(UID, 9156);
	elseif (Class == 3 or Class == 9 or Class == 10) then
		UpdateEvent(UID, 9161);
	elseif (Class == 4 or Class == 11 or Class == 12) then
		UpdateEvent(UID, 9166);
	end
end
...
if (EVENT == 9084) then
	Class = CheckClass(UID);
	if (Class == 1 or Class == 5 or Class == 6) then
		UpdateEvent(UID, 9154);
	elseif (Class == 2 or Class == 7 or Class == 8) then
		UpdateEvent(UID, 9159);
	elseif (Class == 3 or Class == 9 or Class == 10) then
		UpdateEvent(UID, 9164);
	elseif (Class == 4 or Class == 11 or Class == 12) then
		UpdateEvent(UID, 9169);
	end
end
...
if (EVENT == 9090) then
	Class = CheckClass(UID);
	if (Class == 1 or Class == 5 or Class == 6) then
		UpdateEvent(UID, 9153);
		EVENT = 9091
	elseif (Class == 2 or Class == 7 or Class == 8) then
		UpdateEvent(UID, 9158);
		EVENT = 9091
	elseif (Class == 3 or Class == 9 or Class == 10) then
		UpdateEvent(UID, 9163);
		EVENT = 9091
	elseif (Class == 4 or Class == 11 or Class == 12) then
		UpdateEvent(UID, 9168);
		EVENT = 9091
	end
end
...
if (EVENT == 9088) then
	...
	if (Class == 1 or Class == 5 or Class == 6) then
		...
		UpdateEvent(UID, 9152);
		ShowEffect(UID, 300391);
	elseif (Class == 2 or Class == 7 or Class == 8) then
		GiveItem(UID, 246004003, 1)
		UpdateEvent(UID, 9157);
		ShowEffect(UID, 300391);
	elseif (Class == 3 or Class == 9 or Class == 10) then
		GiveItem(UID, 266004003, 1)
		UpdateEvent(UID, 9162);
		ShowEffect(UID, 300391);
	elseif (Class == 4 or Class == 11 or Class == 12) then
		GiveItem(UID, 286004003, 1)
		UpdateEvent(UID, 9167);
		ShowEffect(UID, 300391);
	end 
end
...
if (EVENT == 9100) then -- 60 Level Apostle
	Class = CheckClass(UID);
	if (Class == 1 or Class == 5 or Class == 6) then
		UpdateEvent(UID, 9192);
		EVENT = 9101
	elseif (Class == 2 or Class == 7 or Class == 8) then
		UpdateEvent(UID, 9197);
		EVENT = 9101
	elseif (Class == 3 or Class == 9 or Class == 10) then
		UpdateEvent(UID, 9202);
		EVENT = 9101
	elseif (Class == 4 or Class == 11 or Class == 12) then
		UpdateEvent(UID, 9207);
		EVENT = 9101
	end
end
...
if (EVENT == 9103) then
	Class = CheckClass(UID);
	if (Class == 1 or Class == 5 or Class == 6) then
		UpdateEvent(UID, 9193);
	elseif (Class == 2 or Class == 7 or Class == 8) then
		UpdateEvent(UID, 9198);
	elseif (Class == 3 or Class == 9 or Class == 10) then
		UpdateEvent(UID, 9203);
	elseif (Class == 4 or Class == 11 or Class == 12) then
		UpdateEvent(UID, 9208);
	end
end
...
if (EVENT == 9104) then
	Class = CheckClass(UID);
	if (Class == 1 or Class == 5 or Class == 6) then
		UpdateEvent(UID, 9196);
	elseif (Class == 2 or Class == 7 or Class == 8) then
		UpdateEvent(UID, 9201);
	elseif (Class == 3 or Class == 9 or Class == 10) then
		UpdateEvent(UID, 9206);
	elseif (Class == 4 or Class == 11 or Class == 12) then
		UpdateEvent(UID, 9211);
	end
end
...
if (EVENT == 9110) then
	Class = CheckClass(UID);
	if (Class == 1 or Class == 5 or Class == 6) then
		UpdateEvent(UID, 9195);
		EVENT = 9111
	elseif (Class == 2 or Class == 7 or Class == 8) then
		UpdateEvent(UID, 9200);
		EVENT = 9111
	elseif (Class == 3 or Class == 9 or Class == 10) then
		UpdateEvent(UID, 9205);
		EVENT = 9111
	elseif (Class == 4 or Class == 11 or Class == 12) then
		UpdateEvent(UID, 9210);
		EVENT = 9111
	end
end
...
if (EVENT == 9108) then
	...
	if (Class == 1 or Class == 5 or Class == 6) then
		...
		UpdateEvent(UID, 9194);
		ShowEffect(UID, 300391);
	elseif (Class == 2 or Class == 7 or Class == 8) then
		GiveItem(UID, 246005003, 1)
		UpdateEvent(UID, 9199);
		ShowEffect(UID, 300391);
	elseif (Class == 3 or Class == 9 or Class == 10) then
		GiveItem(UID, 266005003, 1)
		UpdateEvent(UID, 9204);
		ShowEffect(UID, 300391);
	elseif (Class == 4 or Class == 11 or Class == 12) then
		GiveItem(UID, 286005003, 1)
		UpdateEvent(UID, 9209);
		ShowEffect(UID, 300391);
	end
end
...
if (EVENT == 9120) then -- 60 Level Troll
	Class = CheckClass(UID);
	if (Class == 1 or Class == 5 or Class == 6) then
		UpdateEvent(UID, 9234);
		EVENT = 9121
	elseif (Class == 2 or Class == 7 or Class == 8) then
		UpdateEvent(UID, 9239);
		EVENT = 9121
	elseif (Class == 3 or Class == 9 or Class == 10) then
		UpdateEvent(UID, 9244);
		EVENT = 9121
	elseif (Class == 4 or Class == 11 or Class == 12) then
		UpdateEvent(UID, 9249);
		EVENT = 9121
	end
end
...
if (EVENT == 9123) then
	Class = CheckClass(UID);
	if (Class == 1 or Class == 5 or Class == 6) then
		UpdateEvent(UID, 9235);
	elseif (Class == 2 or Class == 7 or Class == 8) then
		UpdateEvent(UID, 9240);
	elseif (Class == 3 or Class == 9 or Class == 10) then
		UpdateEvent(UID, 9245);
	elseif (Class == 4 or Class == 11 or Class == 12) then
		UpdateEvent(UID, 9250);
	end
end
...
if (EVENT == 9124) then
	Class = CheckClass(UID);
	if (Class == 1 or Class == 5 or Class == 6) then
		UpdateEvent(UID, 9238);
	elseif (Class == 2 or Class == 7 or Class == 8) then
		UpdateEvent(UID, 9243);
	elseif (Class == 3 or Class == 9 or Class == 10) then
		UpdateEvent(UID, 9248);
	elseif (Class == 4 or Class == 11 or Class == 12) then
		UpdateEvent(UID, 9253);
	end
end
...
if (EVENT == 9130) then
	Class = CheckClass(UID);
	if (Class == 1 or Class == 5 or Class == 6) then
		UpdateEvent(UID, 9237);
		EVENT = 9131
	elseif (Class == 2 or Class == 7 or Class == 8) then
		UpdateEvent(UID, 9242);
		EVENT = 9131
	elseif (Class == 3 or Class == 9 or Class == 10) then
		UpdateEvent(UID, 9247);
		EVENT = 9131
	elseif (Class == 4 or Class == 11 or Class == 12) then
		UpdateEvent(UID, 9252);
		EVENT = 9131
	end
end
...
if (EVENT == 9128) then
	...
	if (Class == 1 or Class == 5 or Class == 6) then
		...
		UpdateEvent(UID, 9236);
		ShowEffect(UID, 300391);
	elseif (Class == 2 or Class == 7 or Class == 8) then
		GiveItem(UID, 246003003, 1)
		UpdateEvent(UID, 9241);
		ShowEffect(UID, 300391);
	elseif (Class == 3 or Class == 9 or Class == 10) then
		GiveItem(UID, 266003003, 1)
		UpdateEvent(UID, 9246);
		ShowEffect(UID, 300391);
	elseif (Class == 4 or Class == 11 or Class == 12) then
		GiveItem(UID, 286003003, 1)
		UpdateEvent(UID, 9251);
		ShowEffect(UID, 300391);
	end
end
...
if (EVENT == 9160) then -- 60 Level Stone Golem
	Class = CheckClass(UID);
	if (Class == 1 or Class == 5 or Class == 6) then
		UpdateEvent(UID, 9318);
		EVENT = 9161
	elseif (Class == 2 or Class == 7 or Class == 8) then
		UpdateEvent(UID, 9323);
		EVENT = 9161
	elseif (Class == 3 or Class == 9 or Class == 10) then
		UpdateEvent(UID, 9328);
		EVENT = 9161
	elseif (Class == 4 or Class == 11 or Class == 12) then
		UpdateEvent(UID, 9333);
		EVENT = 9161
	end
end
...
if (EVENT == 9163) then
	Class = CheckClass(UID);
	if (Class == 1 or Class == 5 or Class == 6) then
		UpdateEvent(UID, 9319);
	elseif (Class == 2 or Class == 7 or Class == 8) then
		UpdateEvent(UID, 9324);
	elseif (Class == 3 or Class == 9 or Class == 10) then
		UpdateEvent(UID, 9329);
	elseif (Class == 4 or Class == 11 or Class == 12) then
		UpdateEvent(UID, 9334);
	end
end
...
if (EVENT == 9164) then
	Class = CheckClass(UID);
	if (Class == 1 or Class == 5 or Class == 6) then
		UpdateEvent(UID, 9322);
	elseif (Class == 2 or Class == 7 or Class == 8) then
		UpdateEvent(UID, 9327);
	elseif (Class == 3 or Class == 9 or Class == 10) then
		UpdateEvent(UID, 9332);
	elseif (Class == 4 or Class == 11 or Class == 12) then
		UpdateEvent(UID, 9337);
	end
end
...
if (EVENT == 9170) then
	Class = CheckClass(UID);
	if (Class == 1 or Class == 5 or Class == 6) then
		UpdateEvent(UID, 9321);
		EVENT = 9171
	elseif (Class == 2 or Class == 7 or Class == 8) then
		UpdateEvent(UID, 9326);
		EVENT = 9171
	elseif (Class == 3 or Class == 9 or Class == 10) then
		UpdateEvent(UID, 9331);
		EVENT = 9171
	elseif (Class == 4 or Class == 11 or Class == 12) then
		UpdateEvent(UID, 9336);
		EVENT = 9171
	end
end
...
if (EVENT == 9168) then
	...
	if (Class == 1 or Class == 5 or Class == 6) then
		...
		UpdateEvent(UID, 9320);
		ShowEffect(UID, 300391);
	elseif (Class == 2 or Class == 7 or Class == 8) then
		GiveItem(UID, 246001003, 1)
		UpdateEvent(UID, 9325);
		ShowEffect(UID, 300391);
	elseif (Class == 3 or Class == 9 or Class == 10) then
		GiveItem(UID, 266001003, 1)
		UpdateEvent(UID, 9330);
		ShowEffect(UID, 300391);
	elseif (Class == 4 or Class == 11 or Class == 12) then
		GiveItem(UID, 286001003, 1)
		UpdateEvent(UID, 9335);
		ShowEffect(UID, 300391);
	end
end