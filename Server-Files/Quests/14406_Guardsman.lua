...
if (EVENT == 1003) then
	UpdateEvent(UID, 2164);
end

if (EVENT == 1004) then
	UpdateEvent(UID, 2167);
end

if (EVENT == 1005) then
	SelectMsg(UID, 2, savenum, 8418, NPC, 3007, 193);
	UpdateEvent(UID, 2166);
end
...
if (EVENT == 8053) then
	UpdateEvent(UID, 8980);
end

if (EVENT == 8054) then
	UpdateEvent(UID, 8983);
end

if (EVENT == 8055) then
	SelectMsg(UID, 2, 839, 8418, NPC, 3007, 193);
	UpdateEvent(UID, 8982);
end
...
if (EVENT == 9513) then
	UpdateEvent(UID, 9661);
end

if (EVENT == 9514) then
	UpdateEvent(UID, 9664);
end

if (EVENT == 9520) then
	SelectMsg(UID, 2, 920, 8418, NPC, 3007, 193);
	UpdateEvent(UID, 9663);
end
...
if (EVENT == 203) then
	UpdateEvent(UID, 2224);
end

if (EVENT == 204) then
	UpdateEvent(UID, 2227);
end

if (EVENT == 205) then
	UpdateEvent(UID, 2226);
end
...
if (EVENT == 8453) then
	UpdateEvent(UID, 9040);
end

if (EVENT == 8454) then
	UpdateEvent(UID, 9043);
end

if (EVENT == 8455) then
	SelectMsg(UID, 2, 847, 8418, NPC, 3014, 193);
	UpdateEvent(UID, 9042);
end
...
if (EVENT == 303) then
	UpdateEvent(UID, 2320);
end

if (EVENT == 304) then
	UpdateEvent(UID, 2323);
end

if (EVENT == 305) then
	UpdateEvent(UID, 2322);
end
...
if (EVENT == 403) then
	UpdateEvent(UID, 2344);
end

if (EVENT == 404) then
	UpdateEvent(UID, 2347);
end

if (EVENT == 405) then
	UpdateEvent(UID, 2346);
end
...
if (EVENT == 9333) then
	UpdateEvent(UID, 9358);
end

if (EVENT == 9334) then
	UpdateEvent(UID, 9361);
end

if (EVENT == 9335) then
	UpdateEvent(UID, 9360);
...
if (EVENT == 9353) then
	UpdateEvent(UID, 9382);
end

if (EVENT == 9354) then
	UpdateEvent(UID, 9385);
end

if (EVENT == 9355) then
	UpdateEvent(UID, 9384);
