...
if (EVENT == 1003) then
	UpdateEvent(UID, 2020);
end

if (EVENT == 1004) then
	UpdateEvent(UID, 2023);
end

if (EVENT == 1010) then
	UpdateEvent(UID, 2022);
end
...
if (EVENT == 8401) then
	...
	if (Class == 1 or Class == 5 or Class == 6) then
		UpdateEvent(UID, 8490);
	elseif (Class == 2 or Class == 7 or Class == 8) then
		UpdateEvent(UID, 8495);
	elseif (Class == 3 or Class == 9 or Class == 10) then
		UpdateEvent(UID, 8500);
	elseif (Class == 4 or Class == 11 or Class == 12) then
		UpdateEvent(UID, 8505);
	end
end
...
if (EVENT == 8403) then
	Class = CheckClass(UID);
	if (Class == 1 or Class == 5 or Class == 6) then
		UpdateEvent(UID, 8491);
	elseif (Class == 2 or Class == 7 or Class == 8) then
		UpdateEvent(UID, 8496);
	elseif (Class == 3 or Class == 9 or Class == 10) then
		UpdateEvent(UID, 8501);
	elseif (Class == 4 or Class == 11 or Class == 12) then
		UpdateEvent(UID, 8506);
	end
end
...
if (EVENT == 8404) then
	Class = CheckClass(UID);
	if (Class == 1 or Class == 5 or Class == 6) then
		UpdateEvent(UID, 8494);
	elseif (Class == 2 or Class == 7 or Class == 8) then
		UpdateEvent(UID, 8499);
	elseif (Class == 3 or Class == 9 or Class == 10) then
		UpdateEvent(UID, 8504);
	elseif (Class == 4 or Class == 11 or Class == 12) then
		UpdateEvent(UID, 8509);
	end
end
...
if (EVENT == 8410) then
	Class = CheckClass(UID);
	if (Class == 1 or Class == 5 or Class == 6) then
		UpdateEvent(UID, 8493);
	elseif (Class == 2 or Class == 7 or Class == 8) then
		UpdateEvent(UID, 8498);
	elseif (Class == 3 or Class == 9 or Class == 10) then
		UpdateEvent(UID, 8503);
	elseif (Class == 4 or Class == 11 or Class == 12) then
		UpdateEvent(UID, 8508);
	end
end
...
if (EVENT == 8408) then
	...
	if (Class == 1 or Class == 5 or Class == 6) then
		...
		UpdateEvent(UID, 8492);
	elseif (Class == 2 or Class == 7 or Class == 8) then
		GiveItem(UID, 245005290, 1)
		ExpChange(UID, 300000)
		UpdateEvent(UID, 8497);
	elseif (Class == 3 or Class == 9 or Class == 10) then
		GiveItem(UID, 265005291, 1)
		ExpChange(UID, 300000)
		UpdateEvent(UID, 8502);
	elseif (Class == 4 or Class == 11 or Class == 12) then
		GiveItem(UID, 285005292, 1)
		ExpChange(UID, 300000)
		UpdateEvent(UID, 8507);
	end
end
...
if (EVENT == 1103) then
	UpdateEvent(UID, 2092);
end

if (EVENT == 1104) then
	UpdateEvent(UID, 2095);
end

if (EVENT == 1110) then
	UpdateEvent(UID, 2094);
end
...
if (EVENT == 8851) then
	Class = CheckClass(UID);
	if (Class == 1 or Class == 5 or Class == 6) then
		UpdateEvent(UID, 8742);
	elseif (Class == 2 or Class == 7 or Class == 8) then
		UpdateEvent(UID, 8747);
	elseif (Class == 3 or Class == 9 or Class == 10) then
		UpdateEvent(UID, 8752);
	elseif (Class == 4 or Class == 11 or Class == 12) then
		UpdateEvent(UID, 8757);
	end
end
...
if (EVENT == 8853) then
	Class = CheckClass(UID);
	if (Class == 1 or Class == 5 or Class == 6) then
		UpdateEvent(UID, 8743);
	elseif (Class == 2 or Class == 7 or Class == 8) then
		UpdateEvent(UID, 8748);
	elseif (Class == 3 or Class == 9 or Class == 10) then
		UpdateEvent(UID, 8753);
	elseif (Class == 4 or Class == 11 or Class == 12) then
		UpdateEvent(UID, 8758);
	end
end
...
if (EVENT == 8854) then
	Class = CheckClass(UID);
	if (Class == 1 or Class == 5 or Class == 6) then
		UpdateEvent(UID, 8746);
	elseif (Class == 2 or Class == 7 or Class == 8) then
		UpdateEvent(UID, 8751);
	elseif (Class == 3 or Class == 9 or Class == 10) then
		UpdateEvent(UID, 8756);
	elseif (Class == 4 or Class == 11 or Class == 12) then
		UpdateEvent(UID, 8761);
	end
end
...
if (EVENT == 8860) then
	Class = CheckClass(UID);
	if (Class == 1 or Class == 5 or Class == 6) then
		UpdateEvent(UID, 8745);
	elseif (Class == 2 or Class == 7 or Class == 8) then
		UpdateEvent(UID, 8750);
	elseif (Class == 3 or Class == 9 or Class == 10) then
		UpdateEvent(UID, 8755);
	elseif (Class == 4 or Class == 11 or Class == 12) then
		UpdateEvent(UID, 8760);
	end
end
...
if (EVENT == 8858) then
	...
	if (Class == 1 or Class == 5 or Class == 6) then
		...
		GoldGain(UID, 100000)
		UpdateEvent(UID, 8744);
	elseif (Class == 2 or Class == 7 or Class == 8) then
		GiveItem(UID, 245004005, 1)
		ExpChange(UID, 900000)
		GoldGain(UID, 100000)
		UpdateEvent(UID, 8749);
	elseif (Class == 3 or Class == 9 or Class == 10) then
		GiveItem(UID, 265004005, 1)
		ExpChange(UID, 900000)
		GoldGain(UID, 100000)
		UpdateEvent(UID, 8754);
	elseif (Class == 4 or Class == 11 or Class == 12) then
		GiveItem(UID, 285004005, 1)
		ExpChange(UID, 900000)
		GoldGain(UID, 100000)
		UpdateEvent(UID, 8759);
	end
end