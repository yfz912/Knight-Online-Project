...
if EVENT == 8750 then
   Class = CheckClass(UID);
    ...
    UpdateEvent(UID, 8679);
    EVENT = 8751
    elseif Class == 2 or Class == 7 or Class == 8 then
    UpdateEvent(UID, 8684);
    EVENT = 8751
    elseif Class == 3 or Class == 9 or Class == 10 then
    UpdateEvent(UID, 8689);
    EVENT = 8751
   elseif Class == 4 or Class == 11 or Class == 12 then
    UpdateEvent(UID, 8694);
    EVENT = 8751
   end
end
...
if EVENT == 8753 then --수락시
   Class = CheckClass(UID);
    if Class == 1 or Class == 5 or Class == 6 then
    UpdateEvent(UID, 8680);
    elseif Class == 2 or Class == 7 or Class == 8 then
    UpdateEvent(UID, 8685);
    elseif Class == 3 or Class == 9 or Class == 10 then
    UpdateEvent(UID, 8690);
    elseif Class == 4 or Class == 11 or Class == 12 then
    UpdateEvent(UID, 8695);
   end
end

if EVENT == 8754 then
   UpdateEvent(UID, 8683); -- 거절시 
end
...
if EVENT == 8760 then
   Class = CheckClass(UID);
    if Class == 1 or Class == 5 or Class == 6 then
    UpdateEvent(UID, 8682);
    EVENT = 8761
    elseif Class == 2 or Class == 7 or Class == 8 then
    UpdateEvent(UID, 8687);
    EVENT = 8761
    elseif Class == 3 or Class == 9 or Class == 10 then
    UpdateEvent(UID, 8692);
    EVENT = 8761
   elseif Class == 4 or Class == 11 or Class == 12 then
    UpdateEvent(UID, 8697);
    EVENT = 8761
   end
end
...
if EVENT == 8950 then
   Class = CheckClass(UID);
    if Class == 1 or Class == 5 or Class == 6 then
    UpdateEvent(UID, 8763);
    EVENT = 8951
    elseif Class == 2 or Class == 7 or Class == 8 then
    UpdateEvent(UID, 8768);
    EVENT = 8951
    elseif Class == 3 or Class == 9 or Class == 10 then
    UpdateEvent(UID, 8773);
    EVENT = 8951
   elseif Class == 4 or Class == 11 or Class == 12 then
    UpdateEvent(UID, 8778);
     EVENT = 8951
   end
end
...
if EVENT == 8953 then --수락시
   Class = CheckClass(UID);
    if Class == 1 or Class == 5 or Class == 6 then
    UpdateEvent(UID, 8764);
    elseif Class == 2 or Class == 7 or Class == 8 then
    UpdateEvent(UID, 8769);
    elseif Class == 3 or Class == 9 or Class == 10 then
    UpdateEvent(UID, 8774);
    elseif Class == 4 or Class == 11 or Class == 12 then
    UpdateEvent(UID, 8779);
   end
end

if EVENT == 8954 then
   UpdateEvent(UID, 8767); -- 거절시 
end
...
if EVENT == 8960 then
   Class = CheckClass(UID);
    if Class == 1 or Class == 5 or Class == 6 then
    UpdateEvent(UID, 8766);
    EVENT = 8961
    elseif Class == 2 or Class == 7 or Class == 8 then
    UpdateEvent(UID, 8771);
    EVENT = 8961
    elseif Class == 3 or Class == 9 or Class == 10 then
    UpdateEvent(UID, 8776);
    EVENT = 8961
   elseif Class == 4 or Class == 11 or Class == 12 then
    UpdateEvent(UID, 8781);
    EVENT = 8961
   end
end
...
if EVENT == 8958 then
    ...
    Check = CheckExchange(UID, 973)
        if  Check == true then        
        RunExchange(UID, 973);
        UpdateEvent(UID, 8765);
        UpdateEvent(UID, 8786);
        ShowEffect(UID, 300391)
        else
        Ret = 1; 
        end  
...
if EVENT == 8170 then
   Class = CheckClass(UID);
    if Class == 1 or Class == 5 or Class == 6 then
    UpdateEvent(UID, 8805);
    EVENT = 8171
    elseif Class == 2 or Class == 7 or Class == 8 then
    UpdateEvent(UID, 8810);
    EVENT = 8171
    elseif Class == 3 or Class == 9 or Class == 10 then
    UpdateEvent(UID, 8815);
    EVENT = 8171
   elseif Class == 4 or Class == 11 or Class == 12 then
    UpdateEvent(UID, 8820);
     EVENT = 8171
   end
end
...
if EVENT == 8173 then --수락시
   Class = CheckClass(UID);
    if Class == 1 or Class == 5 or Class == 6 then
    UpdateEvent(UID, 8806);
    elseif Class == 2 or Class == 7 or Class == 8 then
    UpdateEvent(UID, 8811);
    elseif Class == 3 or Class == 9 or Class == 10 then
    UpdateEvent(UID, 8816);
    elseif Class == 4 or Class == 11 or Class == 12 then
    UpdateEvent(UID, 8821);
   end
end

if EVENT == 8174 then
   UpdateEvent(UID, 8809); -- 거절시 
end
...
if EVENT == 8180 then
   Class = CheckClass(UID);
    if Class == 1 or Class == 5 or Class == 6 then
    UpdateEvent(UID, 8808);
    EVENT = 8181
    elseif Class == 2 or Class == 7 or Class == 8 then
    UpdateEvent(UID, 8813);
    EVENT = 8181
    elseif Class == 3 or Class == 9 or Class == 10 then
    UpdateEvent(UID, 8818);
    EVENT = 8181
   elseif Class == 4 or Class == 11 or Class == 12 then
    UpdateEvent(UID, 8823);
    EVENT = 8181
   end
end
...
if EVENT == 9063 then
   UpdateEvent(UID, 9118);
end

if EVENT == 9064 then
   UpdateEvent(UID, 9121);
end
...
if EVENT == 9140 then
   Class = CheckClass(UID);
    if Class == 1 or Class == 5 or Class == 6 then
    UpdateEvent(UID, 9255);
    EVENT = 9141
    elseif Class == 2 or Class == 7 or Class == 8 then
    UpdateEvent(UID, 9260);
    EVENT = 9141
    elseif Class == 3 or Class == 9 or Class == 10 then
    UpdateEvent(UID, 9265);
    EVENT = 9141
   elseif Class == 4 or Class == 11 or Class == 12 then
    UpdateEvent(UID, 9270);
     EVENT = 9141
   end
end
...
if EVENT == 9145 then --수락시
   ...
   Class = CheckClass(UID);
    if Class == 1 or Class == 5 or Class == 6 then
    UpdateEvent(UID, 9256);
    elseif Class == 2 or Class == 7 or Class == 8 then
    UpdateEvent(UID, 9261);
    elseif Class == 3 or Class == 9 or Class == 10 then
    UpdateEvent(UID, 9266);
    elseif Class == 4 or Class == 11 or Class == 12 then
    UpdateEvent(UID, 9271);
   end
end

if EVENT == 9146 then
   UpdateEvent(UID, 9259); -- 거절시 
end
...
if EVENT == 9153 then
   Class = CheckClass(UID);
    if Class == 1 or Class == 5 or Class == 6 then
    UpdateEvent(UID, 9258);
    EVENT = 9154
    elseif Class == 2 or Class == 7 or Class == 8 then
    UpdateEvent(UID, 9263);
    EVENT = 9154
    elseif Class == 3 or Class == 9 or Class == 10 then
    UpdateEvent(UID, 9268);
    EVENT = 9154
   elseif Class == 4 or Class == 11 or Class == 12 then
    UpdateEvent(UID, 9273);
    EVENT = 9154
   end
end
...
if EVENT == 9324 then
	SelectMsg(UID, 2, 894, 8676, 24432, 10, 168);
   UpdateEvent(UID, 9340);
end

-- 재료를 다 모았을때 시드와 미셀의 또 등장 
if EVENT == 9325 then
   UpdateEvent(UID, 9342);
...
if EVENT == 9344 then
	SelectMsg(UID, 2, 897, 8680, 24432, 10, 168);
   UpdateEvent(UID, 9364);
end

-- 재료를 다 모았을때 시드와 미셀의 또 등장 
if EVENT == 9345 then
   UpdateEvent(UID, 9366);
   NATION = CheckNation(UID);
   if NATION == 1 then -- 카루스 일때
...
if EVENT == 9430 then
   Class = CheckClass(UID);
    if Class == 1 or Class == 5 or Class == 6 then
    UpdateEvent(UID, 9471);
     EVENT = 9431
    elseif Class == 2 or Class == 7 or Class == 8 then
    UpdateEvent(UID, 9476);
     EVENT = 9431
    elseif Class == 3 or Class == 9 or Class == 10 then
    UpdateEvent(UID, 9481);
     EVENT = 9431
   elseif Class == 4 or Class == 11 or Class == 12 then
    UpdateEvent(UID, 9486);
     EVENT = 9431
   end
end
if EVENT == 9431 then
...
if EVENT == 9433 then --수락시
   Class = CheckClass(UID);
    if Class == 1 or Class == 5 or Class == 6 then
    UpdateEvent(UID, 9472);
    elseif Class == 2 or Class == 7 or Class == 8 then
    UpdateEvent(UID, 9477);
    elseif Class == 3 or Class == 9 or Class == 10 then
    UpdateEvent(UID, 9482);
    elseif Class == 4 or Class == 11 or Class == 12 then
    UpdateEvent(UID, 9487);
   end
end

if EVENT == 9434 then    UpdateEvent(UID, 9475);
end
...
if EVENT == 9440 then
   Class = CheckClass(UID);
    if Class == 1 or Class == 5 or Class == 6 then
    UpdateEvent(UID, 9474);
   EVENT = 9442
    elseif Class == 2 or Class == 7 or Class == 8 then
    UpdateEvent(UID, 9479);
   EVENT = 9442
    elseif Class == 3 or Class == 9 or Class == 10 then
    UpdateEvent(UID, 9484);
   EVENT = 9442
   elseif Class == 4 or Class == 11 or Class == 12 then
    UpdateEvent(UID, 9489);
   EVENT = 9442
   end
end
...
if EVENT == 9450 then
   Class = CheckClass(UID);
    if Class == 1 or Class == 5 or Class == 6 then
    UpdateEvent(UID, 9513);
     EVENT = 9451
    elseif Class == 2 or Class == 7 or Class == 8 then
    UpdateEvent(UID, 9518);
     EVENT = 9451
    elseif Class == 3 or Class == 9 or Class == 10 then
    UpdateEvent(UID, 9523);
     EVENT = 9451
   elseif Class == 4 or Class == 11 or Class == 12 then
    UpdateEvent(UID, 9528);
     EVENT = 9451
   end
end
if EVENT == 9451 then
...
if EVENT == 9453 then --수락시
   Class = CheckClass(UID);
    if Class == 1 or Class == 5 or Class == 6 then
    UpdateEvent(UID, 9514);
    elseif Class == 2 or Class == 7 or Class == 8 then
    UpdateEvent(UID, 9519);
    elseif Class == 3 or Class == 9 or Class == 10 then
    UpdateEvent(UID, 9524);
    elseif Class == 4 or Class == 11 or Class == 12 then
    UpdateEvent(UID, 9529);
   end
end

if EVENT == 9454 then    UpdateEvent(UID, 9517);
end
...
if EVENT == 9460 then
   Class = CheckClass(UID);
    if Class == 1 or Class == 5 or Class == 6 then
    UpdateEvent(UID, 9516);
   EVENT = 9462
    elseif Class == 2 or Class == 7 or Class == 8 then
    UpdateEvent(UID, 9521);
   EVENT = 9462
    elseif Class == 3 or Class == 9 or Class == 10 then
    UpdateEvent(UID, 9526);
   EVENT = 9462
   elseif Class == 4 or Class == 11 or Class == 12 then
    UpdateEvent(UID, 9531);
   EVENT = 9462
   end
end
