...
if (EVENT == 286) then
	SelectMsg(UID, 2, 415, 4172, NPC, 4161, 287, 4162, 241);
end
...
if (EVENT == 360) then
	...
	if (Loyalty > 100) then
		...
		SelectMsg(UID, 3, savenum, 4156, NPC, 4152, 362, 4153, 364, 4154, 241);
	end
end
...
if (EVENT == 363) then
	...
	if (ITEM_COUNT < 350000) then
		...
		SelectMsg(UID, 4, savenum, 4159, NPC, 22, 364, 23, 241);
	end
end
