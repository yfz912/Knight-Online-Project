...
if (EVENT == 202) then
	UpdateEvent(UID, 3064);
end

if (EVENT == 205) then
	UpdateEvent(UID, 3066);
...
if (EVENT == 225) then
	UpdateEvent(UID, 3083);
end

if (EVENT == 226) then
	UpdateEvent(UID, 3085);
...
if (EVENT == 305) then
	UpdateEvent(UID, 3103);
end

if (EVENT == 306) then
	UpdateEvent(UID, 3105);
...
if (EVENT == 405) then
	UpdateEvent(UID, 3123);
end

if (EVENT == 406) then
	UpdateEvent(UID, 3125);
...
if (EVENT == 533) then
	UpdateEvent(UID, 4124);
end

if (EVENT == 534) then
	UpdateEvent(UID, 4127);
end

if (EVENT == 535) then
	UpdateEvent(UID, 4126);
