...
if (EVENT == 118) then -- Golden Pickax
	DCPRE = HowmuchItem(UID, 399281685);
	if (DCPRE < 1) then
...
if (EVENT == 135) then
	OREADS = HowmuchItem(UID, 900000000); -- ITEM KONTROL EDILMELI
	if (OREADS < 1) then
		SelectMsg(UID, 2, -1, 9991, NPC, 18, 1000);
	else
		RobItem(UID, 900000000, 1) -- ITEM KONTROL EDILMELI
...
if (EVENT == 110) then -- Premium Item Use
	PREM = GetPremium(UID);
	if (PREM == 0) then
		SelectMsg(UID, 3, -1, 9527, NPC, 7197, 176, 7198, 181, 7252, 182, 7199, 2100, 10005 , 2101);
	else
...
if (EVENT == 2012) then
	WARPREM = HowmuchItem(UID, 900771875);
	if (WARPREM < 1) then
		SelectMsg(UID, 2, -1, 9528, NPC, 18, 1000);
	else
		RobItem(UID, 900771875, 1)
