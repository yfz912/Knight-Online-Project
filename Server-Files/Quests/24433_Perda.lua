...
if EVENT == 185 then
   MonsterCount  = QuestMonsterCount(UID, 101, 1);
...
if EVENT == 235 then
	MonsterCount = QuestMonsterCount(UID, 103, 1);
	if (MonsterCount < 5) then
...
-- bu sorunsuz demi kecon sorunlu ne sorunu var girip gösterem 1 saniye abi kok
...
if EVENT == 605 then
	MonsterCount = QuestMonsterCount(UID, 323, 1);
...
if (EVENT == 705) then
	MonsterCount = QuestMonsterCount(UID, 324, 1);
	if (MonsterCount < 5) then
...
if EVENT == 9215 then
	MonsterCount = QuestMonsterCount(UID, 886, 1);
	if MonsterCount < 10 then
...
if (EVENT == 805) then
	MonsterCount = QuestMonsterCount(UID, 325, 1);
...
if (EVENT == 9235) then
	MonsterCount = QuestMonsterCount(UID, 887, 1);
...
if (EVENT == 1005) then
	MonsterCount = QuestMonsterCount(UID, 327, 1);
	if (MonsterCount < 10) then
...
if (EVENT == 905) then
	MonsterCount = QuestMonsterCount(UID, 326, 1);
	if (MonsterCount < 10) then
...
if (EVENT == 9255) then
	MonsterCount = QuestMonsterCount(UID, 888, 1);
	if (MonsterCount < 25) then
...
if (EVENT == 9275) then
	MonsterCount = QuestMonsterCount(UID, 890, 1);
...
if (EVENT == 9295) then
	MonsterCount = QuestMonsterCount(UID, 891, 1);
...
if (EVENT == 8636) then
	MonsterCount = QuestMonsterCount(UID, 8090, 1);
	if (MonsterCount < 25) then
