...
if (EVENT == 533) then
	UpdateEvent(UID, 4082);
end

if (EVENT == 534) then
	UpdateEvent(UID, 4085); 
end

if (EVENT == 535) then
	UpdateEvent(UID, 4084);
...
if (EVENT == 225) then
	UpdateEvent(UID, 3153);
end

if (EVENT == 226) then
	UpdateEvent(UID, 3155);
...
if (EVENT == 305) then
	UpdateEvent(UID, 3173);
end

if (EVENT == 306) then
	UpdateEvent(UID, 3175);
...
if (EVENT == 405) then
	UpdateEvent(UID, 3193);
end

if (EVENT == 406) then
	UpdateEvent(UID, 3195);
	SelectMsg(UID, 2, 312, 3086, NPC, 21, 193);
end

if (EVENT == 407) then
	UpdateEvent(UID, 3196);
end
