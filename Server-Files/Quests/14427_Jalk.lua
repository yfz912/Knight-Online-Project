...
if (EVENT == 8708) then
	Class = CheckClass(UID);
	if (Class == 1 or Class == 5 or Class == 6) then
		GiveItem(UID, 972010790, 1)
		GiveItem(UID, 972050433, 1)
		GiveItem(UID, 972080821, 1)
		GiveItem(UID, 972090735, 1)
		ExpChange(UID, 270000)
		SaveEvent(UID, 8420);
	elseif (Class == 2 or Class == 7 or Class == 8) then
		GiveItem(UID, 972020495, 1)
		GiveItem(UID, 972020495, 1)
		GiveItem(UID, 972060922, 1)
		ExpChange(UID, 270000)
		SaveEvent(UID, 8425);
	elseif (Class == 3 or Class == 9 or Class == 10) then
		GiveItem(UID, 972030357, 1)
		GiveItem(UID, 972030365, 1)
		GiveItem(UID, 972030373, 1)
		ExpChange(UID, 270000)
		SaveEvent(UID, 8430);
	elseif (Class == 4 or Class == 11 or Class == 12) then
		GiveItem(UID, 972040765, 1)
		GiveItem(UID, 972070762, 1)
		ExpChange(UID, 270000)
		SaveEvent(UID, 8435);
	end
end
...
if (EVENT == 1106) then
	MonsterCount = CountMonsterQuestSub(UID, 1832, 1);
	if (MonsterCount < 10) then
