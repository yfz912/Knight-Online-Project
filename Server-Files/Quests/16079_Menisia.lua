...
if (EVENT == 308) then
	...
	if (ITEM_COUNT < 5) then
		...
		SelectMsg(UID, 4, 66, 301, NPC, 4006, 310, 27, 193);
	end
end
...
if (EVENT == 319) then
	...
	if (ITEM_COUNT < 5) then
		...
		SelectMsg(UID, 4, 82, 314, NPC, 4006, 321, 27, 193);
	end
end
...
if (EVENT == 1004) then
	UpdateEvent(UID, 1862);
end

if (EVENT == 1006) then
	UpdateEvent(UID, 1864);
...
if (EVENT == 1104) then
	UpdateEvent(UID, 1868);
end

if (EVENT == 1106) then
	UpdateEvent(UID, 1870);
...
if (EVENT == 1201) then
	Class = CheckClass(UID);
	if (Class == 1 or Class == 5 or Class == 6) then
		UpdateEvent(UID, 1873);
	elseif (Class == 2 or Class == 7 or Class == 8) then
		UpdateEvent(UID, 1878);
	elseif (Class == 3 or Class == 9 or Class == 10) then
		UpdateEvent(UID, 1883);
	elseif (Class == 4 or Class == 11 or Class == 12) then
		UpdateEvent(UID, 1888);
	end
end
...
if (EVENT == 1204) then
	Class = CheckClass(UID);
	if (Class == 1 or Class == 5 or Class == 6) then
		UpdateEvent(UID, 1874);
	elseif (Class == 2 or Class == 7 or Class == 8) then
		UpdateEvent(UID, 1879);
	elseif (Class == 3 or Class == 9 or Class == 10) then
		UpdateEvent(UID, 1884);
	elseif (Class == 4 or Class == 11 or Class == 12) then
		UpdateEvent(UID, 1889);
	end
end
...
if (EVENT == 1206) then
	Class = CheckClass(UID);
	if (Class == 1 or Class == 5 or Class == 6) then
		UpdateEvent(UID, 1876);
		SelectMsg(UID, 2, savenum, 9352, NPC, 10, 193);
	elseif (Class == 2 or Class == 7 or Class == 8) then
		UpdateEvent(UID, 1881);
		SelectMsg(UID, 2, savenum, 9352, NPC, 10, 193);
	elseif (Class == 3 or Class == 9 or Class == 10) then
		UpdateEvent(UID, 1886);
		SelectMsg(UID, 2, savenum, 9352, NPC, 10, 193);
	elseif (Class == 4 or Class == 11 or Class == 12) then
		UpdateEvent(UID, 1891);
		SelectMsg(UID, 2, savenum, 9352, NPC, 10, 193);
	end
end
...
if (EVENT == 1301) then
	Class = CheckClass(UID);
	if (Class == 1 or Class == 5 or Class == 6) then
		UpdateEvent(UID, 1894);
	elseif (Class == 2 or Class == 7 or Class == 8) then
		UpdateEvent(UID, 1899);
	elseif (Class == 3 or Class == 9 or Class == 10) then
		UpdateEvent(UID, 1904);
	elseif (Class == 4 or Class == 11 or Class == 12) then
		UpdateEvent(UID, 1909);
	end
end
...
if (EVENT == 1304) then
	Class = CheckClass(UID);
	if (Class == 1 or Class == 5 or Class == 6) then
		UpdateEvent(UID, 1895);
	elseif (Class == 2 or Class == 7 or Class == 8) then
		UpdateEvent(UID, 1900);
	elseif (Class == 3 or Class == 9 or Class == 10) then
		UpdateEvent(UID, 1905);
	elseif (Class == 4 or Class == 11 or Class == 12) then
		UpdateEvent(UID, 1910);
	end
end
...
if (EVENT == 1306) then
	Class = CheckClass(UID);
	if (Class == 1 or Class == 5 or Class == 6) then
		UpdateEvent(UID, 1897);
		SelectMsg(UID, 2, savenum, 9353, NPC, 10, 193);
	elseif (Class == 2 or Class == 7 or Class == 8) then
		UpdateEvent(UID, 1902);
		SelectMsg(UID, 2, savenum, 9353, NPC, 10, 193);
	elseif (Class == 3 or Class == 9 or Class == 10) then
		UpdateEvent(UID, 1907);
		SelectMsg(UID, 2, savenum, 9353, NPC, 10, 193);
	elseif (Class == 4 or Class == 11 or Class == 12) then
		UpdateEvent(UID, 1912);
		SelectMsg(UID, 2, savenum, 9353, NPC, 10, 193);
	end
end
...
if (EVENT == 1308) then
	Class = CheckClass(UID);
	if (Class == 1 or Class == 5 or Class == 6) then
		UpdateEvent(UID, 1896);
	elseif (Class == 2 or Class == 7 or Class == 8) then
		UpdateEvent(UID, 1901);
	elseif (Class == 3 or Class == 9 or Class == 10) then
		UpdateEvent(UID, 1906);
	elseif (Class == 4 or Class == 11 or Class == 12) then
		UpdateEvent(UID, 1911);
	end
end