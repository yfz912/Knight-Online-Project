...
if (EVENT == 165) then
	SelectMsg(UID, 3, -1, 4131, NPC, 40433, 201, 8978, 200, 8647, 300, 8651 ,9000, 8652, 600, 8979, 500, 4404, 400);
end
...
--	SelectMsg(UID, 3, -1, 1111, NPC, 40433, 203, 8978, 204, 4585, 205, 4586, 206, 7162, 207, 7163, 208, 4005, 168);
...
if (EVENT == 500) then
	SelectMsg(UID, 3, -1, 4901, NPC, 4285, 558, 4286, 501, 4287, 502, 4420, 511, 4421, 516, 4589, 521, 4588, 526,7244,548,7243,549,4504, 531);
end
