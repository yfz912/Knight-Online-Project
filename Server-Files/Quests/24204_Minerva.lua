...
if (EVENT == 202) then
	UpdateEvent(UID, 3074);
end

if (EVENT == 205) then
	UpdateEvent(UID, 3076);
...
if (EVENT == 210) then
	...
	if (ITEM_COUNT <= 0) then
		SelectMsg(UID, 2, 70, 3019, NPC, 10, 213);
	else
		SelectMsg(UID, 4, 70, 3022, NPC, 41, 214, 27, 193);
	end
end
...
if (EVENT == 225) then
	UpdateEvent(UID, 3093);
end

if (EVENT == 226) then
	UpdateEvent(UID, 3095);
...
if (EVENT == 305) then
	UpdateEvent(UID, 3113);
end

if (EVENT == 306) then
	UpdateEvent(UID, 3115);
...
if (EVENT == 405) then
	UpdateEvent(UID, 3133);
end

if (EVENT == 406) then
	UpdateEvent(UID, 3135);
...
if (EVENT == 533) then
	UpdateEvent(UID, 4118);
end

if (EVENT == 534) then
	UpdateEvent(UID, 4121); 
end

if (EVENT == 535) then
	UpdateEvent(UID, 4120);
